...
const Sidebar = ({ selectedItem, handleItemClick, userName, handleLogout }) => {
  ...
  return (
    <>
      ...
      {/* Hiển thị Sidebar trên thiết bị di động */}
      <s.MobileSidebar>
        <s.MobileSidebarOverlay showMobileSidebar={showMobileSidebar} onClick={toggleMobileSidebar} />
        {showMenuIcon && (
        ...
        <s.MobileSidebarContent showMobileSidebar={showMobileSidebar}>
          <s.MobileSidebarHeader>
            {showMobileSidebar && (
              <CloseIcon onClick={toggleMobileSidebar} />
            )}
          </s.MobileSidebarHeader>
          <s.LogoContainer>
            <s.Logo src={LogoImage} alt="Website Logo" />
